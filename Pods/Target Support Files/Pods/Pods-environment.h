...
// KILabel
#define COCOAPODS_POD_AVAILABLE_KILabel
#define COCOAPODS_VERSION_MAJOR_KILabel 1
#define COCOAPODS_VERSION_MINOR_KILabel 0
#define COCOAPODS_VERSION_PATCH_KILabel 0
